...
DELETE FROM d_cientificos_datos.VS_Prop_morosos;
INSERT INTO d_cientificos_datos.VS_Prop_morosos
SELECT
	A.cod_banco, 
	B.ano,
	B.mes,
...
COLLECT STAT ON d_cientificos_datos.VS_Prop_morosos COLUMN Ano;
COLLECT STAT ON d_cientificos_datos.VS_Prop_morosos COLUMN Cod_Banco;
COLLECT STAT ON d_cientificos_datos.VS_Prop_morosos COLUMN Cod_mes;
COLLECT STAT ON d_cientificos_datos.VS_Prop_morosos COLUMN Mes;
COLLECT STAT ON d_cientificos_datos.VS_Prop_morosos COLUMN Prop_morosos_30;
COLLECT STAT ON d_cientificos_datos.VS_Prop_morosos INDEX IDX;

---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
INSERT INTO d_cientificos_datos.VS_var_bancos
SELECT 
		A.nro_cuenta, 
		A.cod_mes, 
		A.cod_banco,
...
COLLECT STAT ON d_cientificos_datos.VS_var_bancos COLUMN Cod_Banco;
COLLECT STAT ON d_cientificos_datos.VS_var_bancos COLUMN Cod_Mes;
COLLECT STAT ON d_cientificos_datos.VS_var_bancos COLUMN Nro_Cuenta;
